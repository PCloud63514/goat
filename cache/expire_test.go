...
func TestExpireCache_New(t *testing.T) {
	cache := NewExpireCache[*TestExpireCacheItem]("Name", 10, defaultKeyFunc, time.Second*3, false)
...
func TestExpireCache_Get(t *testing.T) {
	cache := NewExpireCache[*TestExpireCacheItem]("Name", 10, defaultKeyFunc, time.Second*1, false)
